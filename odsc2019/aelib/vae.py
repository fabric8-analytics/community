...
class VariationalAutoEncoder:
    ...
    def __init__(self, input_dim, dims, z_dim, activations, epoch=1, noise=None, loss='cross-entropy',
    ...
    def fit(self, data_x, x_valid=None):
        ...
        self.run_latent(data_x=x, hidden_dim=self.n_z, batch_size=self.batch_size,
            lr=self.lr, epoch=1, print_step=self.print_step)
        self.run_all(data_x=data_x, lr=self.lr, batch_size=self.batch_size,
            epoch=1, print_step=self.print_step, x_valid=x_valid)
